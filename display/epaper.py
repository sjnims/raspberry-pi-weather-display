...
try:
    from waveshare_epaper_it8951 import IT8951
except ImportError:
    IT8951 = None  # type: ignore
...
def display_png(
    ...
    *,
    ...
    try:
        epd.set_vcom(int(VCOM_VOLTS * 1000))  # millivolts
    except (AttributeError, TypeError):
        epd.set_vcom(VCOM_VOLTS)  # volts
    ...
    epd.display(png_path.as_posix(), ROTATE_0=True, mode=mode)
    epd.sleep()
